...
Full assignment review pass (2026-07-08, reviewer stance against `docs/AI Technical Assignment - Retail Company.pdf`) produced new backlog tasks **0022–0027**. Tasks **0016** through **0024** are **done** (user approved 2026-07-08); task **0025** is **pending_review**; tasks **0026–0027** are **todo**.
...
4. **0025 (medium/high)** — CI and eval gate hardening: **pending_review** — GitHub Actions `pytest` + dry-run eval; docs clarify dry-run vs live.
